<?php 
include("header.php"); 
include_once("admin_templateclass/alphabet_listing_manager.php"); 
$classObject		= 	new alphabet_listing_class();
$managerObject 		=	new alphabet_listing_manager();
...
<script type="text/javascript">
 ...
 <h3 class="page-title">Alphabet Listing </h3>
                   <ul class="breadcrumb">
                       <li>
          ...
          <!-- BEGIN ADVANCED TABLE widget-->
           ...
           <div style="float: left;margin-bottom: 20px;">
                	<a href="add_alphabet.php" title="Add Alphabet"><button class="btn btn-info"><i class="icon-plus"></i> Add Letter</button></a>
                </div>
            ...
            <div class="row-fluid">
                ...
                <div class="widget gray">
                    ...
                    <div class="widget-title">
                        ...
                        <h4><i class="icon-reorder"></i>Alphabet Listing</h4>
                            <span class="tools">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                            	...
                            	<th class="align_center_t">Symbol Name</th>    
                            ...
                            <?php if($memberlist) {
									...
									{
										$id		=	$memberlist[$i]['id'];
										$name	=	$memberlist[$i]['alpha_name'];	
										$image  =  $memberlist[$i]['image'];
										$status =   $memberlist[$i]['is_active'];
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td  class="align_center_t">
                                	<img src="upload/<?php echo $image; ?>" style="height: 30px;width: 18px;"/> 
                                </td>
                                <td class="align_center_t">
                                 
                                  <a style="color: #fff" href="add_alphabet.php?edit_id=<?php echo $id; ?>" class="btn btn-primary a_hover" title="Edit"><i class="icon-pencil"></i></a>
                                 <?php if($status=="N") { ?>
                                  	<a href="alphabet_listing.php?active=<?php echo $id; ?>" title="Deactive" class="btn btn-danger" onclick='javascript: return activate_single(this);'><i class="icon-ban-circle"></i></a>	
                                 <?php } else { ?>
                                 	<a href="alphabet_listing.php?deactive=<?php echo $id; ?>" title="Active" class="btn btn-success" onclick='javascript: return deactivate_single(this);'><i class="icon-ok"></i></a>
                                 <?php } ?> 
                               <a style="color: #fff" href="alphabet_listing.php?delete_id=<?php echo $id; ?>" title="Delete" class="btn btn-danger a_hover" onclick='javascript: return delete_single_confirm(this);'><i class="icon-trash"></i></a>
                                </td>
                            </tr>
                            <?php } } ?>
                            </tbody>
